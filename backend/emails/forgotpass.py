...
def send_reset_password_email(username, usermail, reset_link):
    ...
    We received a request to reset your password for your MoonAnalyzer account.
    ...
    # HTML content for the reset password email
