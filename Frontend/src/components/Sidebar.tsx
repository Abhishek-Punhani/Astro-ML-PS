...
const Sidebar = ({SidebarStatus}:any) => {
  ...
  return (
    <>
    <div className={`${BarOpen?'lg:w-1/5':'lg:w-0'} ${smBarOpen?'w-64':'w-0'} top-0 h-screen py-4 border-r flex flex-col overflow-scroll fixed transition-width ease-in-out delay-150 bg-white z-10`}>
